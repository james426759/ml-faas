...
def handle(req):
    ...
    uuid_renamed_h5 = function_name + '-' + fname.split('.')[0] + '-' + file_uuid + '.' + 'h5'

    
    client.fget_object(last_pipeline_bucket_name, 'xt-'+last_pipeline_file_name, '/home/app/xt.json')
    client.fget_object(last_pipeline_bucket_name, 'yt-'+last_pipeline_file_name, '/home/app/yt.json')
